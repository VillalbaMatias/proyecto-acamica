 ...
 for(var contador = 0; contador<noticias.length; contador++){
    noticiaActual = noticias[contador];
      ...
      if (contienePalabra(noticiaActual, palabra)){
        cambiarColor(noticiaActual, 'rgb(20, 162, 29)');
      }
...
function resaltarNoticias(palabra){
 for(var contador = 0; contador<noticias.length; contador++){
    noticiaActual = noticias[contador];
    

      if (contienePalabra(noticiaActual, palabra)){
        cambiarColor(noticiaActual, 'rgb(108, 39, 226)');
      }
...
resaltarNoticias("robots");
resaltarNoticias("robot");
